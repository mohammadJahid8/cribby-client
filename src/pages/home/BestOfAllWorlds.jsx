...
import Icon4 from "../../assets/Icon4.json";
import phone2 from "../../assets/phone2.json";
...
const BestOfAllWorlds = () => {
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-36">
            <div className="flex flex-col md:flex-row justify-center items-center gap-5 w-6/12 md:w-auto mx-auto">
              <div className="rounded-3xl">
                <Lottie className="" animationData={Icon1} />
              </div>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-5 w-6/12 md:w-auto mx-auto">
              <div className="rounded-3xl">
                <Lottie className="" animationData={Icon2} />
              </div>
              <div className="space-y-4 text-center md:text-start">
                <h3 className="text-pink text-xl md:text-2xl font-medium">
                  CribbyAI Chatbot
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-5 w-6/12 md:w-auto mx-auto">
              <div className="rounded-3xl">
                <Lottie className="" animationData={Icon3} />
              </div>
              <div className="space-y-4 text-center md:text-start">
                <h3 className="text-pink text-xl md:text-2xl font-medium">
                  Smart Filters
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-5 w-6/12 md:w-auto mx-auto">
              <div className="rounded-3xl">
                <Lottie className="" animationData={Icon4} />
              </div>
              <div className="space-y-4 text-center md:text-start">
                <h3 className="text-pink text-xl md:text-2xl font-medium">
                  AI-Driven Features
      ...
      <div className=" pt-20 bg-gradient-to-b from-secondary via-neutral to-secondary flex justify-center items-center flex-col overflow-hidden space-y-12">
        <div className="w-11/12 mx-auto text-white text-center space-y-5">
          <h2 className="text-4xl md:text-5xl font-medium">
            Best of all worlds
          </h2>
        ...
        <div className="md:w-6/12 transform md:-translate-y-32 relative">
          ...
          <div className="w-10/12 md:w-full mx-auto">
            <Lottie className="z-0" loop={true} animationData={phone2} />
            {/* <video autoPlay loop muted>
              <source src="/Animations3.mp4" type="video/mp4" />
